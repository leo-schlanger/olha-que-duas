...
import { Menu, Youtube, X, Radio } from "lucide-react";
...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ["inicio", "sobre", "servicos", "radio", "podcast", "contacto"];
  ...
  return (
    <header
      className={cn(
        ...
        isScrolled
          ? "bg-background/95 backdrop-blur-lg shadow-lg shadow-black/5 py-2"
